...
then choose **Extensions: Install from VSIX…** from the Command
Palette. No global CLI or Node.js installation is required.
...
安装方法：在 VS Code 或 Cursor 的扩展面板搜索 **AI Change Radar**，认准发布者
**QCoding**，然后点击“安装”。离线使用时，从
[最新 GitHub Release](https://github.com/qcodingdev/change-evidence/releases/latest)
下载 `.vsix`，再执行“Extensions: Install from VSIX…”。
...
[Privacy](https://github.com/qcodingdev/change-evidence/blob/main/plugins/vscode/PRIVACY.md) ·
[Support](https://github.com/qcodingdev/change-evidence/blob/main/plugins/vscode/SUPPORT.md) ·
[MIT License](https://github.com/qcodingdev/change-evidence/blob/main/plugins/vscode/LICENSE)
